...
WebUI.click(findTestObject('logercyharg/Page_Life Charger   a new beginning/span_Search for_fa fa-search'))


WebUI.verifyElementPresent(findTestObject('Object Repository/logercyharg/Page_Life Charger   a new beginning/a_Home'), 2)
WebUI.closeBrowser()
